# Model 2 - Multi-layer Perceptron (Context Window of Size 2 - Only Operation Nodes)
...
class Model2MLP(SkLearnModelBase):
	feature_names = ['operation_0_type', 'operation_1_type']
